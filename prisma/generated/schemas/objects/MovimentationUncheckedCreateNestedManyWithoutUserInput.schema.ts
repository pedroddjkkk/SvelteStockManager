...
const Schema: z.ZodType<Prisma.MovimentationUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const MovimentationUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
