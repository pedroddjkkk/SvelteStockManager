...
const Schema: z.ZodType<Prisma.MovimentationCreateNestedManyWithoutProductInput> = z
	.object({
		create: z
			.union([
...
export const MovimentationCreateNestedManyWithoutProductInputObjectSchema = Schema;
