...
const Schema: z.ZodType<Prisma.MovimentationUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const MovimentationUpdateManyWithoutUserNestedInputObjectSchema = Schema;
