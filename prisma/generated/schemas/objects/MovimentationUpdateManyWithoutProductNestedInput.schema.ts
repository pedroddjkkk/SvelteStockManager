...
const Schema: z.ZodType<Prisma.MovimentationUpdateManyWithoutProductNestedInput> = z
	.object({
		create: z
			.union([
...
export const MovimentationUpdateManyWithoutProductNestedInputObjectSchema = Schema;
